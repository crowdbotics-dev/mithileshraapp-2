"""
Django settings for mithileshraapp_2 project.
...
ROOT_URLCONF = 'mithileshraapp_2.urls'
...
WSGI_APPLICATION = 'mithileshraapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithileshraapp_2 API",
    "DESCRIPTION": "API documentation for mithileshraapp_2 App",
    "VERSION": "v1",
}
